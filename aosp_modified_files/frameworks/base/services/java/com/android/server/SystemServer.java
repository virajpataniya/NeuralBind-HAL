...
public final class SystemServer implements Dumpable {
    ...
    private void startOtherServices(@NonNull TimingsTraceAndSlog t) {
        ...
        // --------------------------------------------------------
        // NeuralBind AI System Service
        // --------------------------------------------------------
        t.traceBegin("StartNeuralBindService");
        try {
            Slog.i(TAG, "Starting NeuralBind AI Service");
            mSystemServiceManager.startService(com.android.server.neuralbind.NeuralBindService.class);
        } catch (Throwable e) {
            reportWtf("starting NeuralBind Service", e);
        }
        t.traceEnd();
